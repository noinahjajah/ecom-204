...
export default function About() {
  ...
  return (
    <div className="about">
      {/* Announcement bar */}
      <div className="ab-announce">จัดส่งฟรีทุกออเดอร์ตั้งแต่ 1,500 บาท · แถมกระเป๋าผ้าลิมิเต็ด</div>
      ...
      <header className="ab-header">
        ...
        <nav>
          <ul className="ab-nav">
            ...
            <li><a href="/about" className="active">เกี่ยวกับเรา</a></li>
          </ul>
        </nav>
        <div className="ab-header-icons">
          <button className="ab-icon-btn" aria-label="ค้นหา">
            <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4">
              <circle cx="11" cy="11" r="7" />
              <line x1="21" y1="21" x2="16.65" y2="16.65" />
            </svg>
          </button>
          <a className="ab-icon-btn" aria-label="บัญชีของฉัน" href="/login">
            <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4">
              <circle cx="12" cy="8" r="4" />
              <path d="M4 21c0-4.4 3.6-8 8-8s8 3.6 8 8" />
            </svg>
          </a>
          <button className="ab-icon-btn" aria-label="ตะกร้าสินค้า">
            <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4">
              <path d="M6 8h12l-1.2 11.2a2 2 0 0 1-2 1.8H9.2a2 2 0 0 1-2-1.8L6 8Z" />
              <path d="M9 8V6a3 3 0 0 1 6 0v2" />
            </svg>
            <span className="ab-bag-count">2</span>
          </button>
        </div>
      </header>
