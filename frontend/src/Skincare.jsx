...
export default function Skincare() {
  ...
  return (
    <div className="skincare">
      {/* Announcement bar */}
      <div className="sc-announce">จัดส่งฟรีทุกออเดอร์ตั้งแต่ 1,500 บาท · แถมกระเป๋าผ้าลิมิเต็ด</div>
      ...
      <header className="sc-header">
        ...
        <nav>
          <ul className="sc-nav">
            ...
            <li><a href="/skincare" className="active">สกินแคร์</a></li>
            <li><a href="/makeup">เมคอัพ</a></li>
            <li><a href="/about">เกี่ยวกับเรา</a></li>
          </ul>
        </nav>
        <div className="sc-header-icons">
          <button className="sc-icon-btn" aria-label="ค้นหา">
            <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4">
              <circle cx="11" cy="11" r="7" />
              <line x1="21" y1="21" x2="16.65" y2="16.65" />
            </svg>
          </button>
          <a className="sc-icon-btn" aria-label="บัญชีของฉัน" href="/login">
            <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4">
              <circle cx="12" cy="8" r="4" />
              <path d="M4 21c0-4.4 3.6-8 8-8s8 3.6 8 8" />
            </svg>
          </a>
          <button className="sc-icon-btn" aria-label="ตะกร้าสินค้า">
            <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4">
